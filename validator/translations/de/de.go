...
func RegisterDefaultTranslations(v *validator.Validate, trans ut.Translator) (err error) {
	translations := []struct {
		...
		{
			tag:         "required",
			translation: "{0} ist erforderlich",
			override:    false,
		},
		{
			tag:         "required_if",
		...
		},
		{
			...
			customRegisFunc: func(ut ut.Translator) (err error) {
				...
				if err = ut.Add("min-number", "{0} muss {1} oder mehr sein", false); err != nil {
					return
				}
		...
		},
		{
			tag: "max",
			customRegisFunc: func(ut ut.Translator) (err error) {
				if err = ut.Add("max-string", "{0} darf höchstens {1} lang sein", false); err != nil {
					return
				}
				...
				if err = ut.Add("max-number", "{0} muss {1} oder weniger sein", false); err != nil {
					return
				}
		...
		},
		{
			tag: "lt",
			customRegisFunc: func(ut ut.Translator) (err error) {
				if err = ut.Add("lt-string", "{0} muss kürzer als {1} sein", false); err != nil {
					return
				}
				...
				if err = ut.Add("lt-items", "{0} muss weniger als {1} enthalten", false); err != nil {
					return
				}
				...
				if err = ut.Add("lt-datetime", "{0} muss vor dem aktuellen Datum & Uhrzeit liegen", false); err != nil {
					return
				}
		...
		},
		{
			tag: "lte",
			customRegisFunc: func(ut ut.Translator) (err error) {
				if err = ut.Add("lte-string", "{0} darf höchstens {1} lang sein", false); err != nil {
					return
				}
				...
				if err = ut.Add("lte-number", "{0} muss {1} oder weniger sein", false); err != nil {
					return
				}

				if err = ut.Add("lte-items", "{0} darf höchstens {1} enthalten", false); err != nil {
					return
				}
				...
				if err = ut.Add("lte-datetime", "{0} muss gleich oder früher als das aktuelle Datum & Uhrzeit sein", false); err != nil {
					return
				}
		...
		},
		{
			tag: "gt",
			customRegisFunc: func(ut ut.Translator) (err error) {
				if err = ut.Add("gt-string", "{0} muss länger als {1} sein", false); err != nil {
					return
				}
				...
				if err = ut.Add("gt-datetime", "{0} muss später als das aktuelle Datum & Uhrzeit sein", false); err != nil {
					return
				}
		...
		},
		{
			...
			customRegisFunc: func(ut ut.Translator) (err error) {
				...
				if err = ut.Add("gte-number", "{0} muss mindestens {1} sein", false); err != nil {
					return
				}
				...
				if err = ut.Add("gte-datetime", "{0} muss gleich oder später als das aktuelle Datum & Uhrzeit sein", false); err != nil {
					return
				}
		...
		{
			tag:         "eqfield",
			translation: "{0} muss dem Feld {1} entsprechen",
			override:    false,
			customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
				t, err := ut.T(fe.Tag(), fe.Field(), fe.Param())
				if err != nil {
		...
		{
			tag:         "numeric",
			translation: "{0} muss ein gültiger numerischer Wert sein",
			override:    false,
		},
		{
			tag:         "number",
		...
		{
			tag:         "hexadecimal",
			translation: "{0} muss ein gültiges Hexadezimal sein",
			override:    false,
		},
		{
			tag:         "hexcolor",
			translation: "{0} muss eine gültige HEX-Farbe sein",
			override:    false,
		},
		{
			tag:         "rgb",
		...
		{
			tag:         "e164",
			translation: "{0} muss eine gültige E.164 formatierte Telefonnummer sein",
			override:    false,
		},
		{
			tag:         "email",
		...
		{
			tag:         "base64",
			translation: "{0} muss ein gültiger Base64-String sein",
			override:    false,
		},
		{
			tag:         "contains",
		...
		{
			tag:         "excludesrune",
			translation: "{0} darf folgendes nicht enthalten '{1}'",
			override:    false,
			customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
				t, err := ut.T(fe.Tag(), fe.Field(), fe.Param())
				if err != nil {
		...
		{
			tag:         "multibyte",
			translation: "{0} muss mehrbyte Zeichen enthalten",
			override:    false,
		},
		{
			tag:         "datauri",
			translation: "{0} muss eine gültige Data-URI enthalten",
			override:    false,
		},
		{
			tag:         "latitude",
		...
		{
			tag:         "ssn",
			translation: "{0} muss eine gültige Sozialversicherungsnummer sein",
			override:    false,
		},
		{
			tag:         "ipv4",
		...
		{
			tag:         "mac",
			translation: "{0} muss eine gültige MAC-Adresse enthalten",
			override:    false,
		},
		{
			tag:         "fqdn",
			translation: "{0} muss ein gültiger FQDN sein",
			override:    false,
		},
		{
			tag:         "unique",
		...
		{
			tag:         "cron",
			translation: "{0} muss ein gültiger Cron-Ausdruck sein",
			override:    false,
		},
		{
			tag:         "oneof",
			translation: "{0} muss einer von [{1}] sein",
			override:    false,
			customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
		...
		{
			tag:         "json",
			translation: "{0} muss ein gültiger JSON-String sein",
			override:    false,
		},
		{
			tag:         "jwt",
			translation: "{0} muss ein gültiger JWT-String sein",
			override:    false,
		},
		{
			tag:         "lowercase",
			translation: "{0} muss ein String in Kleinbuchstaben sein",
			override:    false,
		},
		{
			tag:         "uppercase",
			translation: "{0} muss ein String in Großbuchstaben sein",
			override:    false,
		},
		{
			tag:         "datetime",
			translation: "{0} entspricht nicht dem Format {1}",
			override:    false,
			customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
				t, err := ut.T(fe.Tag(), fe.Field(), fe.Param())
				if err != nil {
		...
		},
		{
			...
			translation: "{0} entspricht nicht dem Postleitzahlenformat des Landes {1}",
			override:    false,
			customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
				t, err := ut.T(fe.Tag(), fe.Field(), fe.Param())
				if err != nil {
		...
		},
		{
			...
			translation: "{0} entspricht nicht dem Postleitzahlenformat des Landes im Feld {1}",
			override:    false,
			customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
				t, err := ut.T(fe.Tag(), fe.Field(), fe.Param())
				if err != nil {
		...
		{
			tag:         "boolean",
			translation: "{0} muss ein gültiger Boolescher Wert sein",
			override:    false,
		},
		{
			tag:         "image",
			translation: "{0} muss ein gültiges Bild sein",
			override:    false,
		},
		{
			tag:         "cve",
			translation: "{0} muss ein gültiger CVE-Identifikator sein",
			override:    false,
		},
	}
